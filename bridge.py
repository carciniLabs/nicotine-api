...
NICOTINE_LIBS = [
    "/home/crab/.local/lib/python3.12/site-packages",
        ...
        for line in sys.stdin:
            try:
                ...
                if method == "search":
                    ...
                    # Fallback to the actual download path if config resolution doesn't point to a real dir
                    if not downloaddir or not os.path.exists(downloaddir):
                        downloaddir = "/mnt/fangorn/Audio/Music/Unsorted/SLSK"
